...
namespace ClashRoyale.Protocol.Messages.Server
{
    public class LoginFailedMessage : PiranhaMessage
    {
        ...
        {
            Writer.WriteByte(ErrorCode); // ErrorCode //clash royale 1.9.2
            Writer.WriteScString(ResourceFingerprintData); // Fingerprint 
            Writer.WriteScString(null); //clash royale 1.9.2
            Writer.WriteScString(ContentUrl); // Content URL //clash royale 1.9.2
