...
namespace ClashRoyale.Core
{
    public class Configuration
    {
        ...
        [JsonProperty("events_startdate")] public int[] EventsStartDate = new int[] {2020, 3, 5};
        
        [JsonProperty("events")] public string[] Events = new string[0];
        [JsonProperty("events_gamemodes")] public string[] EventsGamemodes = new string[0];
        [JsonProperty("exclusive_cards")] public string[] exclusiveCards = new string[] {"26-100"};
        ...
        public void Initialize()
        {
            if (File.Exists("config.json"))
                try
                {
                    ...
                    EventsGamemodes = config.EventsGamemodes;
                    EventsStartDate = config.EventsStartDate;
                    
                    exclusiveCards = config.exclusiveCards;
                }
                catch (Exception)
                {
