...
namespace ClashRoyale.Core.Leaderboards
{
    public class Leaderboard
    {
        ...
        public int secondsuntilnextmonth = TimeUtils.GetSecondsUntilNextMonth;
        ...
        {
            if (TimeUtils.GetSecondsUntilNextMonth > secondsuntilnextmonth)
            {
                ResetPlayerTrophies();
            }
            secondsuntilnextmonth = TimeUtils.GetSecondsUntilNextMonth;
        ...
        public async void ResetPlayerTrophies()
        {
            PlayerDb.ResetTrophies();
        }
    }
}
