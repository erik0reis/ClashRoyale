...
namespace ClashRoyale.Logic.Home
{
    public class Home
    {
        ...
        [JsonProperty("blockedUntil")] public DateTime blockedUntil = DateTime.UtcNow;
        ...
        [JsonProperty("chestsUnlockTimestamp")] public int[] chestsUnlockTimestamp = new int[] { 0, 0, 0, 0 };
        [JsonProperty("chestsIsUnlocking")] public bool[] chestsIsUnlocking = new bool[] { false, false, false, false };
        [JsonProperty("chestsExists")] public bool[] chestsExists = new bool[] { false, false, false, false };
        ...
        public Home(long id, string token)
        {
            ...
            Decks = new int[6][];
            for (var i = 0; i < 6; i++) Decks[i] = new int[8];
